...
- **Evidence:** [[alimisis2024-diffusion-augmentation-review]] (method menu, metrics), [[yang2023-ai-generated-images-data-source]] (cost/benefit), domain-gap term in [[glossary]].
- **Why not solved:** Augmentation helps-vs-hurts is dataset- and regime-specific; small-object regime under-studied.
- **Demonstrable on anchor?** y — directly measurable with the existing Flux pipeline + an elevator dataset.
